    ...
    return (
        <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white min-h-17.5 tracking-wide relative z-50">
            <div className="flex flex-wrap items-center justify-between gap-5 w-full">
                <a href="javascript:void(0)" className="max-sm:hidden"><img src="https://images.scalebranding.com/11566d3f-6cb3-47d5-bc54-a15558d1352b.png" alt="logo" className="w-15" /></a>
                ...
                <div id="collapseMenu"
                    ...
                    <ul
                        className="lg:flex gap-x-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-75 max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                        ...
                        <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
                            <Link to={"/"}
                            className="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Home</Link>
                        </li>
                        <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><Link to={"/about"}
                            className="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">About</Link>
                        </li>
                        <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><Link to={"/contact"}
                            className="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Contact</Link>
                        </li>
